...
### <a href="{{ '/assets/files/statutes-revised-2020_0.pdf' | relative_url }}" target="_blank" rel="noopener noreferrer">Statutes</a>

### [Code of Conduct]({{ "/content/code-of-conduct/" | relative_url }})

### [Substainability]({{ "/content/sustainability/" | relative_url }})
...
- supervision of the organisation of the **[International Semantic Web Conference series (ISWC)](http://swsa.semanticweb.org/content/international-semantic-web-conference-iswc)**, see **[Call for Bids](http://swsa.semanticweb.org/content/call-host-international-semantic-web-conference#)** for further details.
- supervison of the organisation of the **[Extended Semantic Web Conference series (ESWC)](https://eswc-conferences.org/)**;
